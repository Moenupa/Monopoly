...
class PlayerTest {
    ...
    void moneyTest(){ // Test is the money related functions work normally
        ...
        assertEquals(player.getMoney(),Player.SALARY); // Test if the player begins with the base money
        player.addMoney(500);
    ...
    void positionTest(){ // Test is the position related functions work normally
        var player = new Player("test");
        assertEquals(player.getPosition(),0); // Test if the player is initialized at the starting position
    ...
    void salaryTest(){ //  Test if the player can get the salary normally
        ...
        player.move(5);
        assertEquals(player.getMoney(),Player.SALARY*2); // Test if the function works well if player goes through the starting point
        player.setPosition(18);
        player.move(2);
        assertEquals(player.getMoney(),Player.SALARY*3); // Test if the function works well if the player steps on the starting point
